...
const SIngleService = () => {
  ...
  const handlePurchase = (e) => {
    ...
    const serviceDate = form.get("serviceDate");
  ...
  const otherServices = services.filter(
    (service) =>
      service.serviceProvider.email === providerEmail &&
      service._id !== loader._id
  );
      ...
      <section>
        <div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-xl text-gray-500 font-medium">
              <span className="text-[#4D96B3] font-bold">
                Provider Location:{" "}
              </span>
              {serviceArea}
            </h1>
            ...
            <div className="flex flex-col lg:flex-row justify-evenly px-10 gap-4">
              ...
              <div className="space-y-3">
                ...
                <div className="text-center">
                  <button
                    className="w-full py-3 px-4 items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#4D96B3] text-white hover:bg-[#127096]"
              ...
              {/* modal  */}
              {/* form  */}
              <form onSubmit={handlePurchase} id="myForm">
                    ...
                    <div className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                      <div className="relative flex flex-col bg-gray-800 shadow-lg rounded-xl">
                        <div className="absolute top-2 end-2 z-[10]">
                          <button
                            type="button"
                            className="inline-flex justify-center items-center w-8 h-8 text-sm font-semibold rounded-lg border border-transparent bg-[#4D96B3] text-white hover:bg-white/20"
                            data-hs-overlay="#hs-subscription-with-image"
                          >
                        ...
                        <div>
                          <div className="aspect-w-16 aspect-h-8">
                            ...
                            <input
                              name="serviceImage"
                              className="hidden w-full object-cover rounded-t-xl"
                              value={serviceImage}
                              readOnly
                            />
                          </div>
            ...
            <div className="max-w-7xl mx-auto mt-32 mb-32">
              {otherServices.length > 0 ? (
                ...
                <div className="flex flex-col justify-center items-center">
                  <div className="text-2xl mb-2 text-gray-500 font-bold">
                    {" "}
                    No other services Found here
                  </div>
                  <img
                    className="w-96 rounded-full"
                    src="https://i.ibb.co/yVZJPrB/photo-1593341832681-6cb2ce1ed053-q-80-w-1968-auto-format-fit-crop-ixlib-rb-4-0.jpg"
                    alt=""
                  />
                </div>
              )}
