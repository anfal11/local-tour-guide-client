...
console.log(user);
           ...
           const serviceFilter = service.filter(service => service.serviceProvider.email === user.email);
    ...
    return (
        ...
        <Header />
            ...
            <section>
                    <h1 className="text-2xl text-gray-500 text-center mb-14 mt-10">Your Services</h1>
